...
export default function NewZealandPage() {
  return (
    <main className="newzealand-page">
      <Header />
      ...
      <section className="dso-visa-section">
        <img
          ...
          src="/banners/NEW ZEALAND D.png"
          alt="Study in New Zealand Banner"
        />
        <img
          className="dso-visa-banner-mobile"
          src="/banners/NEW ZEALAND M.png"
          alt="Study in New Zealand Banner"
        />
      </section>

      {/* Section 2: Top Courses in New Zealand */}
      <TopCourses />

      {/* Section 3: Cost of Living */}
      <CostOfLiving />

      {/* Section 4: Steps to Study in New Zealand */}
      <StepsToStudy />
...
function TopCourses() {
  ...
  const courses = [
    ...
    { icon: "🌿", name: "Agriculture & Environmental Studies", tag: "Top Picked" },
    ...
    <section className="uni-section">
      ...
      <div className="uni-container">
        ...
        <p className="uni-intro">
          Some of the most in-demand courses and programs in New Zealand:
        </p>
...
function CostOfLiving() {
  ...
  const costs = [
    { icon: "🏠", category: "Accommodation", price: "NZD 500 – 1,200" },
    { icon: "🍴", category: "Food & Groceries", price: "NZD 250 – 400" },
    { icon: "🚌", category: "Transport", price: "NZD 80 – 150" },
    { icon: "💼", category: "Miscellaneous", price: "NZD 150 – 300" },
  ];
      ...
      <div className="steps-container">
        <div className="steps-header">
          <div className="steps-label">
            ...
            Steps to Study in New Zealand
          </div>

          <div className="steps-fire-badge">🧭 &nbsp; Your Roadmap to New Zealand</div>

          <h2 className="steps-headline">
            Your Path to New Zealand — <span className="steps-underline">Simplified.</span>
          </h2>
        </div>
        ...
        <div className="steps-footnote">
          <div className="steps-footnote-inner">
            ...
            <p className="steps-footnote-text">
              With the <strong>right guidance</strong>, studying in New Zealand becomes achievable.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="cta-section">
      ...
      <div className="cta-container">
        ...
        <h2 className="cta-headline">
          Ready to Study in <span className="cta-underline">New Zealand?</span> 🇳🇿
        </h2>
