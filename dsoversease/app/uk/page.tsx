...
export default function UKPage() {
  return (
    <main className="uk-page">
      ...
      {/* Section 4: Steps to Study in UK */}
      <StepsToStudy />
...
function TopCourses() {
  ...
  const courses = [
    ...
    { icon: "🤖", name: "Data Science & Artificial Intelligence", tag: "High Demand" },
    { icon: "⚖️", name: "Law", tag: "Top Picked" },
      ...
      <div className="uni-container">
        <div className="uni-header">
          ...
          <h2 className="uni-headline">
            Courses That Fast-Track <span className="uni-underline">Your Career.</span>
          </h2>
        </div>

        <p className="uni-intro">
          Some of the most in-demand courses and programs in the UK:
        </p>
...
function CostOfLiving() {
  ...
  const costs = [
    { icon: "🏠", category: "Accommodation", price: "£500 – £1,200" },
    { icon: "🍴", category: "Food & Groceries", price: "£150 – £300" },
    { icon: "🚌", category: "Transport", price: "£50 – £120" },
    { icon: "💼", category: "Miscellaneous", price: "£150 – £300" },
  ];
      ...
      <div className="col-container">
        <div className="col-header">
          ...
          <h2 className="col-headline">
            Plan Smart. <span>Live Better.</span>
          </h2>
        ...
        <div className="col-insight">
          <div className="col-insight-inner">
            ...
            <p className="col-insight-text">
              <strong>Part-time work</strong> and student discounts help manage daily expenses in the UK.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="steps-footnote">
          <div className="steps-footnote-inner">
            ...
            <p className="steps-footnote-text">
              With the <strong>right guidance</strong>, studying in the UK becomes achievable.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="cta-section">
      ...
      <div className="cta-container">
        ...
        <h2 className="cta-headline">
          Ready to Study in the <span className="cta-underline">UK?</span> 🇬🇧
        </h2>
